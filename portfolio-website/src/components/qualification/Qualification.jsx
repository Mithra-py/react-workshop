        ...
        <section className="qualification section" id='portfolio'>
            ...
            <div className="qualification__container container">
                ...
                <div className="qualification__sections">
                    ...
                    <div className={toggleState === 1 ? "quaalification__content quaalification__content-active" : "qualification__content"}>
                    ...
                    <div className={toggleState === 2 ? "quaalification__content quaalification__content-active" : "qualification__content"}>
                        <div className="qualification__data">
                            <div>
